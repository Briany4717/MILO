...
clean_containers() {
    echo -e "${YELLOW}🗑️  Limpiando contenedores parados...${NC}"
...
clean_images() {
    echo -e "${YELLOW}🖼️  Limpiando imágenes sin usar...${NC}"
...
clean_temp_files() {
    echo -e "${YELLOW}🗂️  Limpiando archivos temporales del proyecto...${NC}"
        ...
        while true; do
            ...
            case $choice in
                ...
                2)
                    ...
                    ;;
                3)
                    echo -e "${RED}⚠️  Limpieza agresiva - puede eliminar datos importantes${NC}"
